        ...
        <div class="main-footer row">
            <div class="container clear-padding">
                ...
                <div class="col-md-12 text-center we-accept">
                    <h4>We Accept</h4>
                    <ul>
                        <li><img src="<?=base_url()?>images/mastercard.png" alt="cruise"></li>
                        <li><img src="<?=base_url()?>images/visa.png" alt="cruise"></li>
                        <li><img src="<?=base_url()?>images/american-express.png" alt="cruise"></li>
                        <li><img src="<?=base_url()?>images/mastercard.png" alt="cruise"></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="main-footer-nav row">
            <div class="container clear-padding">
                <div class="col-md-6 col-sm-6">
                    <p>Copyright &copy; 2016 Daily Rentals. All Rights Reserved. | Powered by ITMARTX</p>
                </div>
